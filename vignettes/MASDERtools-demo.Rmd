...
We drop these items by specifying them in a list; the components are in the order of the scales (which is likely alphabetically). It might be prudent to store this string and print it to the screen for documentation purposes.
